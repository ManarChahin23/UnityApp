...
public class ExampleApp : MonoBehaviour
{
    ...
    {
        IWebRequestResponse webRequestResponse = await enviroment2DApiClient.CreateEnvironment(environment2D);
    ...
    {
        IWebRequestResponse webRequestResponse = await enviroment2DApiClient.DeleteEnvironment(environment2D.id);
    ...
    {
        IWebRequestResponse webRequestResponse = await object2DApiClient.ReadObject2Ds(object2D.environmentId);
    ...
    {
        IWebRequestResponse webRequestResponse = await object2DApiClient.CreateObject2D(object2D);
    ...
    {
        IWebRequestResponse webRequestResponse = await object2DApiClient.UpdateObject2D(object2D);
